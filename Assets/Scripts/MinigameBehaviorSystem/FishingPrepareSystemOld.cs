...
public class FishingPrepareSystemOld : MonoBehaviour
{
    ...
    private bool IsTimeToUpdateAvailables()
    {
    ...
    {
        _currentProbabilities = bait.potential switch
        {
            0 => new List<float>()
            {
                0.8182636f,
